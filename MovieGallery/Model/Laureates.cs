...
namespace QuickType
{
    ...
    public partial class Laureates
    {
        public static Laureates FromJson(string json) => JsonConvert.DeserializeObject<Laureates>(json, QuickType.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Laureates self) => JsonConvert.SerializeObject(self, QuickType.Converter.Settings);
    }
